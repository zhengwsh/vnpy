...
#from ctaBacktestSetting import *
...
########################################################################
class CtaBacktestEngine(object):
    """
    CTA回测引擎
    函数接口和策略引擎保持一样，
    从而实现同一套代码从回测到实盘。
...
if __name__ == '__main__':
    ...
    MODULE_PATH = {}
    MODULE_PATH['ctaStr'] = os.path.join(ROOT_PATH, 'strategy')
    ...
    # 在引擎中创建策略对象
    engine.initStrategy(STRATEGY_CLASS['EmaDemoStrategy'], {})
